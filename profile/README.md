...
Structural Explainability provides the theoretical foundation
for the Civic Interconnect ecosystem, including
Accountable Entities (AE), the Civic Exchange Protocol (CEP),
and Contextual Evidence and Explanations (CEE).

## Index

For a complete, timestamped inventory of papers,
formal results, and proofs, see:

**https://github.com/structural-explainability/structural-explainability**
